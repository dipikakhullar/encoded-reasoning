...
|-------|----------------------|
| 0 | Beliefs static despite evidence. Disconfirming results ignored or explained away. |
| 1 | Acknowledges contradictory evidence but doesn't change course. "Interesting, anyway..." |
| 2 | Updates on strong evidence but slow to do so. May hold onto original framing too long. |
| 3 | Visibly changes beliefs when evidence warrants. Articulates what changed and why. |
| 4 | Updates propagate — when one thing changes, revisits downstream conclusions. Actively seeks disconfirmation. |
| 5 | Exemplary: Eagerly updates on weak evidence, systematically traces implications, and treats belief revision as a feature not a bug. |
